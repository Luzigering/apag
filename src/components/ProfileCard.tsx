...
const ProfileCard: React.FC<ProfileCardProps> = ({ name, imageUrl }) => {
  return (
    <div
      className="
        fixed top-0 left-0 h-screen w-[30vw] bg-[#0d1117] text-white flex flex-col items-center justify-center z-10
        max-lg:relative max-lg:w-full max-lg:min-h-screen max-lg:p-4
      "
    >
      <img
        src={imageUrl}
...
<h1
  className="
    text-5xl font-bold text-center mb-2 gradient-text"
>
  {name}
</h1>
